...
public class AdvancedPanel : MonoBehaviour
{
    ...
    public static AdvancedPanel instance;
    void Awake() {
    ...
    void Start()
    {
        volumeSlider.onValueChanged.AddListener((v) => {
            GameManager.instance.volumeRTPC.SetGlobalValue(v);
        ...
        tempoSlider.onValueChanged.AddListener((v) => {
            ...
            GameManager.instance.tempoRTPC.SetGlobalValue(v);
    ...
    private void OnEnable() {  
        volumeSlider.value = GameManager.instance.volumeRTPC.GetValue(gameObject);
        volumeText.SetText("Master Volume\n" + (int)volumeSlider.value);

        if (NetworkManager.Singleton.IsHost) {
            tempoSlider.interactable = true;
            loopLengthSlider.interactable = true;
            tempoSlider.value = GameManager.instance.tempoRTPC.GetValue(gameObject);
        }
        else {
